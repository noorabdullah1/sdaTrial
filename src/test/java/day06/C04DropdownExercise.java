...
public class C04DropdownExercise {
    ...
    public void test(){
        ...
        //Verifying that the element is multi-select.
            //if it is multiselect ---> TRUE
            //if it is not multiselect ---> FALSE
        //Assert.assertEquals(true,select.isMultiple()); //if both equals which is both true it means it is TRUE
